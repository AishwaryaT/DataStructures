...
public final class Bits {
	 ...
	 * 
	 * @param n
	 * @return Number of bits set, from 0 to 31
	 */
	...
	/*Another way*/
	// I will use this -TA
	public static int countSetBits3(int z){
		int bitCount =0;
		while (z != 0)
		{
	...
	public static void isPowerofTwo(int n){
		if ((n & (n-1)) == 0)
			System.out.println("n is pow of 2"); //returns 0 if n is pow of 2.
		else
